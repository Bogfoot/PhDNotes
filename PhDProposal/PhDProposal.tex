...
to fit into specific DWDM frequency channels. The photons are generated via Spontanious Parametric Down-Conversion (SPDC) from a 50 mm nonlinear periodically polled Lithium Niobate
(PPLN, requires references) crystal in the center of the interferometer. The source is first implemented and characterized in the laboratory by means of quantum state tomography,
...
This limits the efficient distribution of entanglement to only a few hundred kilometers (add some references).
