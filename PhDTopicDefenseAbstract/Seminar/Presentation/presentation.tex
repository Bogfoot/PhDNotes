...
\begin{frame}{Phase Matching}
    ...
    \begin{columns}[t]
        \column{.5\textwidth}
		\captionof{figure}{Phase Matching Temperature for Type-II crystal of 9,12 $\mu$m poling period, $\delta \phi = \frac{L \Delta k}{2}$}
...
\begin{frame}
    \begin{columns}[t]
		...
		\captionof{figure}{Phys. Rev. Lett. 75, 4337  \cite{design4}.}
        \includegraphics[width=\columnwidth]{Design3.png}
		\captionof{figure}{Phys. Rev. Lett. 121, 200502 \cite{design3}.}
        \column{.5\textwidth}
...
\begin{frame}{Present state}
	...
	\begin{figure}[!ht]
	  ...
	  \subfloat[][]{\includegraphics[width=2.9cm]{PMT_Type2_Data.png}}\quad
