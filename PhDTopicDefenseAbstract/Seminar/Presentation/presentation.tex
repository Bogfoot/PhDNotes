...
% Add transition from one to other here
...
% 	\begin{figure}[!ht]
% 	  \centering
% 	  \caption{Illustration of Entanglement a) Teleportation and b) Swapping.}
% 	  \subfloat[][]{\includegraphics[width=5cm]{EntanglementTeleportation.png}}\quad
% 	  \pause
% 	  \subfloat[][]{\includegraphics[width=5cm]{EntanglementSwapping.png}}\\
% 	  \label{fig:SwapTele}
% 	\end{figure}
%
% \end{frame}
