...
The main goal for me in this regard would be to create a bright source of entanglement using a Sagnac interferometer.
The reason we chose a Sagnac in this case is due to its long term vibrational stability, and it's a convenient way to do so as it allows for a compact design.
